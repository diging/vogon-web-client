...
v-list-item(:key="annotation.id")
	v-list-item-content
		...
		div
			...
			| &nbsp;&nbsp;
			router-link(
				:to="`/repository/citesphere/${annotation.occursIn.repository_id}/groups/${annotation.occursIn.group_id}/items/${annotation.occursIn.file_id}/texts/${annotation.occursIn.id}?project_id=${annotation.project}`"
